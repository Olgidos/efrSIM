...
class Data
{
   ...
   Data():
     ...
     //Wheel Front Right
       wheelFR_sx                 { 0.799, "s__Wheel_x_4", "m", "Solid Wheel 4 (FL)"},
       wheelFR_sy                 { -0.6, "s__Wheel_y_4", "m", "Solid Wheel 4 (FL)"},
       wheelFR_sz                 { 0.05, "s__Wheel_z_4", "m", "Solid Wheel 4 (FL)"},

       wheelFR_mass               { "m__Wheel_4", "kg", "Solid Wheel 4 (FL)", displayTime},
       wheelFR_MOIX               { "J__Wheel_x_4", "kg*m^2*°", "Solid Wheel 4 (FL)", displayTime},
       wheelFR_MOIY               { "J__Wheel_y_4", "kg*m^2*°", "Solid Wheel 4 (FL)", displayTime},
       wheelFR_MOIZ               { "J__Wheel_z_4", "kg*m^2*°", "Solid Wheel 4 (FL)", displayTime},

       wheelFRMassRim             { 1.45, "m__Rim_4", "kg", "Solid Wheel 4 (FL)"},
       wheelFRMassTyre            { 3.95, "m__Tyre_4", "kg", "Solid Wheel 4 (FL)"},
       wheelFRMassMotorAssembly   { 7.2, "m__Assembly_4", "kg", "Solid Wheel 4 (FL)"},

       wheelFR_JTyreX             { 0.166, "J__Tyre_x_4", "kg*m^2", "Solid Wheel 4 (FL)"},
       wheelFR_JTyreY             { 0.189, "J__Tyre_y_4", "kg*m^2", "Solid Wheel 4 (FL)"},
       wheelFR_JTyreZ             { 0.116, "J__Tyre_z_4", "kg*m^2", "Solid Wheel 4 (FL)"},
       wheelFR_JRimX              { 0.022, "J__Rim_x_4", "kg*m^2", "Solid Wheel 4 (FL)"},
       wheelFR_JRimY              { 0.035, "J__Rim_y_4", "kg*m^2", "Solid Wheel 4 (FL)"},
       wheelFR_JRimZ              { 0.022, "J__Rim_z_4", "kg*m^2", "Solid Wheel 4 (FL)"},
       wheelFR_JRotorTransmissionX{ 0.001, "J__RotorTransmi_x_4", "kg*m^2", "Solid Wheel 4 (FL)"},
       wheelFR_JRotorTransmissionY{ 0.004, "J__RotorTransmi_y_4", "kg*m^2", "Solid Wheel 4 (FL)"},
       wheelFR_JRotorTransmissionZ{ 0.001, "J__RotorTransmi_z_4", "kg*m^2", "Solid Wheel 4 (FL)"},

       wheelFR_dMotorAssemblyX    { 0.00, "l__Assembly_x_4", "m", "Solid Wheel 4 (FL)"},
       wheelFR_dMotorAssemblyY    { 0.02, "l__Assembly_y_4", "m", "Solid Wheel 4 (FL)"},
       wheelFR_dMotorAssemblyZ    { 0.02, "l__Assembly_z_4", "m", "Solid Wheel 4 (FL)"},

       wheelFRPosX                { "r__Wheel_x_4", "m", "Solid Wheel 4 (FL)", displayTime},
       wheelFRPosY                { "r__Wheel_y_4", "m", "Solid Wheel 4 (FL)", displayTime},
       wheelFRPosZ                { "r__Wheel_z_4", "m", "Solid Wheel 4 (FL)", displayTime},

       wheelFRVeloX               { "v__Wheel_x_4", "m/s", "Solid Wheel 4 (FL)", displayTime},
       wheelFRVeloY               { "v__Wheel_y_4", "m/s", "Solid Wheel 4 (FL)", displayTime},
       wheelFRVeloZ               { "v__Wheel_z_4", "m/s", "Solid Wheel 4 (FL)", displayTime},

       wheelFRAccelX              { "a__Wheel_x_4", "m/(s^2)", "Solid Wheel 4 (FL)", displayTime},
       wheelFRAccelY              { "a__Wheel_y_4", "m/(s^2)", "Solid Wheel 4 (FL)", displayTime},
       wheelFRAccelZ              { "a__Wheel_z_4", "m/(s^2)", "Solid Wheel 4 (FL)", displayTime},

       wheelFRAngularVeloX        { "rotVelo_x_Wheel_4", "°/s", "Solid Wheel 4 (FL)", displayTime},
       wheelFRAngularVeloY        { "rotVelo_y_Wheel_4", "°/s", "Solid Wheel 4 (FL)", displayTime},
       wheelFRAngularVeloZ        { "rotVelo_z_Wheel_4", "°/s", "Solid Wheel 4 (FL)", displayTime},

       wheelFRAngularAccelX       { "rotAccel_x_Wheel_4", "°/(s^2)", "Solid Wheel 4 (FL)", displayTime},
       wheelFRAngularAccelY       { "rotAccel_y_Wheel_4", "°/(s^2)", "Solid Wheel 4 (FL)", displayTime},
       wheelFRAngularAccelZ       { "rotAccel_z_Wheel_4", "°/(s^2)", "Solid Wheel 4 (FL)", displayTime},

       wheelFREulerX              { "rot_x_Wheel_4", "°", "Solid Wheel 4 (FL)", displayTime},
       wheelFREulerY              { "rot_y_Wheel_4", "°", "Solid Wheel 4 (FL)", displayTime},
       wheelFREulerZ              { "rot_z_Wheel_4", "°", "Solid Wheel 4 (FL)", displayTime},

       wheelFR_Fz                 { "F__MFT_z_4", "N", "Solid Wheel 4 (FL)", displayTime},
       wheelFR_Fx                 { "F__MFT_x_4", "N", "Solid Wheel 4 (FL)", displayTime},
       wheelFR_k                  { "k__4", " ", "Solid Wheel 4 (FL)", displayTime},
       wheelFR_ux                 { "u__x_4", " ", "Solid Wheel 4 (FL)", displayTime},
       wheelFRMrollingResistanceY { "M__MFT_y_4", "Nm", "Solid Wheel 4 (FL)", displayTime},
       wheelFRMoverturningCoupleX { "M__MFT_x_4", "Nm", "Solid Wheel 4 (FL)", displayTime},

     //Wheel Rear Left
       wheelRL_sx                 { -0.763, "s__Wheel_x_2", "m", "Solid Wheel 2 (FL)"},
       wheelRL_sy                 { 0.575, "s__Wheel_y_2", "m", "Solid Wheel 2 (FL)"},
       wheelRL_sz                 { 0.05, "s__Wheel_z_2", "m", "Solid Wheel 2 (FL)"},

       wheelRL_mass               { "m__Wheel_2", "kg", "Solid Wheel 2 (FL)", displayTime},
       wheelRL_MOIX               { "J__Wheel_x_2", "kg*m^2*°", "Solid Wheel 2 (FL)", displayTime},
       wheelRL_MOIY               { "J__Wheel_y_2", "kg*m^2*°", "Solid Wheel 2 (FL)", displayTime},
       wheelRL_MOIZ               { "J__Wheel_z_2", "kg*m^2*°", "Solid Wheel 2 (FL)", displayTime},

       wheelRLMassRim             { 1.45, "m__Rim_2", "kg", "Solid Wheel 2 (FL)"},
       wheelRLMassTyre            { 3.95, "m__Tyre_2", "kg", "Solid Wheel 2 (FL)"},
       wheelRLMassMotorAssembly   { 6.7, "m__Assembly_2", "kg", "Solid Wheel 2 (FL)"},

       wheelRL_JTyreX             { 0.116, "J__Tyre_x_2", "kg*m^2", "Solid Wheel 2 (FL)"},
       wheelRL_JTyreY             { 0.189, "J__Tyre_y_2", "kg*m^2", "Solid Wheel 2 (FL)"},
       wheelRL_JTyreZ             { 0.116, "J__Tyre_z_2", "kg*m^2", "Solid Wheel 2 (FL)"},
       wheelRL_JRimX              { 0.022, "J__Rim_x_2", "kg*m^2", "Solid Wheel 2 (FL)"},
       wheelRL_JRimY              { 0.035, "J__Rim_y_2", "kg*m^2", "Solid Wheel 2 (FL)"},
       wheelRL_JRimZ              { 0.022, "J__Rim_z_2", "kg*m^2", "Solid Wheel 2 (FL)"},
       wheelRL_JRotorTransmissionX{ 0.001, "J__RotorTransmi_x_2", "kg*m^2", "Solid Wheel 2 (FL)"},
       wheelRL_JRotorTransmissionY{ 0.004, "J__RotorTransmi_y_2", "kg*m^2", "Solid Wheel 2 (FL)"},
       wheelRL_JRotorTransmissionZ{ 0.001, "J__RotorTransmi_z_2", "kg*m^2", "Solid Wheel 2 (FL)"},

       wheelRL_dMotorAssemblyX    { 0.00, "l__Assembly_x_2", "m", "Solid Wheel 2 (FL)"},
       wheelRL_dMotorAssemblyY    { -0.02, "l__Assembly_y_2", "m", "Solid Wheel 2 (FL)"},
       wheelRL_dMotorAssemblyZ    { 0.02, "l__Assembly_z_2", "m", "Solid Wheel 2 (FL)"},

       wheelRLPosX                { "r__Wheel_x_2", "m" ,"Solid Wheel 2 (FL)", displayTime},
       wheelRLPosY                { "r__Wheel_y_2", "m" ,"Solid Wheel 2 (FL)", displayTime},
       wheelRLPosZ                { "r__Wheel_z_2", "m" ,"Solid Wheel 2 (FL)", displayTime},

       wheelRLVeloX               { "v__Wheel_x_2", "m/s", "Solid Wheel 2 (FL)", displayTime},
       wheelRLVeloY               { "v__Wheel_y_2", "m/s", "Solid Wheel 2 (FL)", displayTime},
       wheelRLVeloZ               { "v__Wheel_z_2", "m/s", "Solid Wheel 2 (FL)", displayTime},

       wheelRLAccelX              { "a__Wheel_x_2", "m/(s^2)", "Solid Wheel 2 (FL)", displayTime},
       wheelRLAccelY              { "a__Wheel_y_2", "m/(s^2)", "Solid Wheel 2 (FL)", displayTime},
       wheelRLAccelZ              { "a__Wheel_z_2", "m/(s^2)", "Solid Wheel 2 (FL)", displayTime},

       wheelRLAngularVeloX        { "rotVelo_x_Wheel_2", "°/s", "Solid Wheel 2 (FL)", displayTime},
       wheelRLAngularVeloY        { "rotVelo_y_Wheel_2", "°/s", "Solid Wheel 2 (FL)", displayTime},
       wheelRLAngularVeloZ        { "rotVelo_z_Wheel_2", "°/s", "Solid Wheel 2 (FL)", displayTime},

       wheelRLAngularAccelX       { "rotAccel_x_Wheel_2", "°/(s^2)", "Solid Wheel 2 (FL)", displayTime},
       wheelRLAngularAccelY       { "rotAccel_y_Wheel_2", "°/(s^2)", "Solid Wheel 2 (FL)", displayTime},
       wheelRLAngularAccelZ       { "rotAccel_z_Wheel_2", "°/(s^2)", "Solid Wheel 2 (FL)", displayTime},

       wheelRLEulerX              { "rot_x_Wheel_2", "°", "Solid Wheel 2 (FL)", displayTime},
       wheelRLEulerY              { "rot_y_Wheel_2", "°", "Solid Wheel 2 (FL)", displayTime},
       wheelRLEulerZ              { "rot_z_Wheel_2", "°", "Solid Wheel 2 (FL)", displayTime},

       wheelRL_Fz                 { "F__MFT_z_2", "N", "Solid Wheel 2 (FL)", displayTime},
       wheelRL_Fx                 { "F__MFT_x_2", "N", "Solid Wheel 2 (FL)", displayTime},
       wheelRL_k                  { "k__2", " ", "Solid Wheel 2 (FL)", displayTime},
       wheelRL_ux                 { "u__x_2", " ", "Solid Wheel 2 (FL)", displayTime},
       wheelRLMrollingResistanceY { "M__MFT_y_2", "Nm", "Solid Wheel 2 (FL)", displayTime},
       wheelRLMoverturningCoupleX { "M__MFT_x_2", "Nm", "Solid Wheel 2 (FL)", displayTime},

     //Wheel Rear Right
       wheelRR_sx                 { -0.763, "s__Wheel_x_3", "m", "Solid Wheel 3 (FL)"},
       wheelRR_sy                 { -0.575, "s__Wheel_y_3", "m", "Solid Wheel 3 (FL)"},
       wheelRR_sz                 { 0.05, "s__Wheel_z_3", "m", "Solid Wheel 3 (FL)"},

       wheelRR_mass               { "m__Wheel_3", "kg", "Solid Wheel 3 (FL)", displayTime},
       wheelRR_MOIX               { "J__Wheel_x_3", "kg*m^2*°", "Solid Wheel 3 (FL)", displayTime},
       wheelRR_MOIY               { "J__Wheel_y_3", "kg*m^2*°", "Solid Wheel 3 (FL)", displayTime},
       wheelRR_MOIZ               { "J__Wheel_z_3", "kg*m^2*°", "Solid Wheel 3 (FL)", displayTime},

       wheelRRMassRim             { 1.45, "m__Rim_3", "kg", "Solid Wheel 3 (FL)"},
       wheelRRMassTyre            { 3.95, "m__Tyre_3", "kg", "Solid Wheel 3 (FL)"},
       wheelRRMassMotorAssembly   { 6.7, "m__Assembly_3", "kg", "Solid Wheel 3 (FL)"},

       wheelRR_JTyreX             { 0.116, "J__Tyre_x_3", "kg*m^2", "Solid Wheel 3 (FL)"},
       wheelRR_JTyreY             { 0.189, "J__Tyre_y_3", "kg*m^2", "Solid Wheel 3 (FL)"},
       wheelRR_JTyreZ             { 0.116, "J__Tyre_z_3", "kg*m^2", "Solid Wheel 3 (FL)"},
       wheelRR_JRimX              { 0.022, "J__Rim_x_3", "kg*m^2", "Solid Wheel 3 (FL)"},
       wheelRR_JRimY              { 0.035, "J__Rim_y_3", "kg*m^2", "Solid Wheel 3 (FL)"},
       wheelRR_JRimZ              { 0.022, "J__Rim_z_3", "kg*m^2", "Solid Wheel 3 (FL)"},
       wheelRR_JRotorTransmissionX{ 0.001, "J__RotorTransmi_x_3", "kg*m^2", "Solid Wheel 3 (FL)"},
       wheelRR_JRotorTransmissionY{ 0.004, "J__RotorTransmi_y_3", "kg*m^2", "Solid Wheel 3 (FL)"},
       wheelRR_JRotorTransmissionZ{ 0.001, "J__RotorTransmi_z_3", "kg*m^2", "Solid Wheel 3 (FL)"},

       wheelRR_dMotorAssemblyX    { 0.00, "l__Assembly_x_3", "m", "Solid Wheel 3 (FL)"},
       wheelRR_dMotorAssemblyY    { 0.02, "l__Assembly_y_3", "m", "Solid Wheel 3 (FL)"},
       wheelRR_dMotorAssemblyZ    { 0.02, "l__Assembly_z_3", "m", "Solid Wheel 3 (FL)"},

       wheelRRPosX                { "r__Wheel_x_3", "m", "Solid Wheel 3 (FL)", displayTime},
       wheelRRPosY                { "r__Wheel_y_3", "m", "Solid Wheel 3 (FL)", displayTime},
       wheelRRPosZ                { "r__Wheel_z_3", "m", "Solid Wheel 3 (FL)", displayTime},

       wheelRRVeloX               { "v__Wheel_x_3", "m/s", "Solid Wheel 3 (FL)", displayTime},
       wheelRRVeloY               { "v__Wheel_y_3", "m/s", "Solid Wheel 3 (FL)", displayTime},
       wheelRRVeloZ               { "v__Wheel_z_3", "m/s", "Solid Wheel 3 (FL)", displayTime},

       wheelRRAccelX              { "a__Wheel_x_3", "m/(s^2)", "Solid Wheel 3 (FL)", displayTime},
       wheelRRAccelY              { "a__Wheel_y_3", "m/(s^2)", "Solid Wheel 3 (FL)", displayTime},
       wheelRRAccelZ              { "a__Wheel_z_3", "m/(s^2)", "Solid Wheel 3 (FL)", displayTime},

       wheelRRAngularVeloX        { "rotVelo_x_Wheel_3", "°/s", "Solid Wheel 3 (FL)", displayTime},
       wheelRRAngularVeloY        { "rotVelo_y_Wheel_3", "°/s", "Solid Wheel 3 (FL)", displayTime},
       wheelRRAngularVeloZ        { "rotVelo_z_Wheel_3", "°/s", "Solid Wheel 3 (FL)", displayTime},

       wheelRRAngularAccelX       { "rotAccel_x_Wheel_3", "°/(s^2)", "Solid Wheel 3 (FL)", displayTime},
       wheelRRAngularAccelY       { "rotAccel_y_Wheel_3", "°/(s^2)", "Solid Wheel 3 (FL)", displayTime},
       wheelRRAngularAccelZ       { "rotAccel_z_Wheel_3", "°/(s^2)", "Solid Wheel 3 (FL)", displayTime},

       wheelRREulerX              { "rot_x_Wheel_3", "°", "Solid Wheel 3 (FL)", displayTime},
       wheelRREulerY              { "rot_y_Wheel_3", "°", "Solid Wheel 3 (FL)", displayTime},
       wheelRREulerZ              { "rot_z_Wheel_3", "°", "Solid Wheel 3 (FL)", displayTime},

       wheelRR_Fz                 { "F__MFT_z_3", "N", "Solid Wheel 3 (FL)", displayTime},
       wheelRR_Fx                 { "F__MFT_x_3", "N", "Solid Wheel 3 (FL)", displayTime},
       wheelRR_k                  { "k__3", " ", "Solid Wheel 3 (FL)", displayTime},
       wheelRR_ux                 { "u__x_3", " ", "Solid Wheel 3 (FL)", displayTime},
       wheelRRMrollingResistanceY { "M__MFT_y_3", "Nm", "Solid Wheel 3 (FL)", displayTime},
       wheelRRMoverturningCoupleX { "M__MFT_x_3", "Nm", "Solid Wheel 3 (FL)", displayTime},

     //Main
       mainInitPosX               { 13.17, "s__Mainbody_x", "m", "Solid Mainbody"},
       mainInitPosY               { 0.0, "s__Mainbody_y", "m", "Solid Mainbody"},
       mainInitPosZ               { 0.285, "s__Mainbody_z", "m","Solid Mainbody"},

       mainMass                   { 111.38, "m__Mainbody", "kg", "Solid Mainbody"},
       driverMass                 { 53.0, "m__Mainbody", "kg", "Solid Mainbody"},

       sxDriver                   { 0.05, "s__Mainbody_x", "m", "Solid Mainbody"},
       syDriver                   { 0.00, "s__Mainbody_y", "m", "Solid Mainbody"},
       szDriver                   { 0.012, "s__Mainbody_z", "m","Solid Mainbody"},
     ...
     // MFT - Parameter 80kPa
       ...
       l_Mux                      { 1.000 , "lambda__ux", " ", "MFT Parameter"},
       ...
       //Energy
       wheelSusFLEnergyFlow       { "E__Suspension_1", "kJ", "Energy", displayTime},
       wheelSusFREnergyFlow       { "E__Suspension_4", "kJ", "Energy", displayTime},
       wheelSusRLEnergyFlow       { "E__Suspension_2", "kJ", "Energy", displayTime},
       wheelSusRREnergyFlow       { "E__Suspension_3", "kJ", "Energy", displayTime},

       MotorFLEnergyFlow          { "E__Motor_1", "kJ", "Energy", displayTime},
       MotorFREnergyFlow          { "E__Motor_4", "kJ", "Energy", displayTime},
       MotorRLEnergyFlow          { "E__Motor_2", "kJ", "Energy", displayTime},
       MotorRREnergyFlow          { "E__Motor_3", "kJ", "Energy", displayTime},

       aeroEnergyFlow             { "E__Aero", "kJ", "Energy", displayTime},
       ...
       total_energy               { "E__kin", "kJ", "Energy", displayTime},
       total_energyFlow           { "E__flow", "kJ", "Energy", displayTime}
